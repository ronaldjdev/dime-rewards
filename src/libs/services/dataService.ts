...
export const dataService = {
   ...
   * @param {any} modelName - El modelo de base de datos del cual se obtendrán los registros.
   ...
   * @param {any} modelName - El modelo de base de datos del cual se obtendrá el registro.
   ...
   * @param {any} modelName - El modelo de base de datos en el cual se creará el registro.
   ...
   * @param {any} modelName - El modelo de base de datos en el cual se actualizará el registro.
   ...
   * @param {any} modelName - El modelo de base de datos del cual se eliminará el registro.
